...
class VideoModule:
    ...
    def __init__(self, _manager, dest=(0, 0), size=(800, 600)):
        ...
        self.dest = dest
        self.size = size
        self.video_panel = pgu.elements.UIPanel(manager=_manager, starting_layer_height=0,
    ...
    def load_video(self, _path_video):
        self.clean()
    ...
    def preview_video(self, dest=(0, 0), size=(100, 100)):
        ...
        while self.flags["time"] is not None and self.flags["video"] is not None:
            ...
            if prev_frame is not self.actual_frame - 1:
                ...
                ui_image.set_image(chunks[self.actual_frame - 1])
    ...
    def preview_sound(self, nbytes=2):
        ...
        total_size = int(audio.fps * self.clip.duration)
    ...
    def preview_graph(self, dest=(0, 0), size=(300, 400)):
        ...
        while self.flags["time"] is not None and self.flags["graph"] is not None:
            ...
            if prev_frame is not self.actual_frame:
                ...
                ui_image.set_image(chunks[self.actual_frame])
    ...
    def export(self, _sub_video_path=""):
        if self.clip is not None:
            ...
            _sub_video_path = os.path.abspath(os.getcwd()) + "\\sub_video.mp4"
            sub_video.write_videofile(filename=_sub_video_path, codec="mpeg4", audio_codec='aac')
            _video.close()
